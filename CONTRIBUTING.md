...
Thank you for your interest in `strong-tools`, an open source project
administered by IBM.

Contributing to `strong-tools` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-tools)
