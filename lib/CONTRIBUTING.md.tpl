...
Thank you for your interest in `<%= name %>`, an open source project
administered by StrongLoop.

Contributing to `<%= name %>` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/<%= repoFullName %>)
